...
public class PlacesConstants {
   ...
   */
  // Max time to wait for locataion polling
  public static int MAX_TIME_TO_GET_LOCATION = 10000; // 10 SEC
  ...
  public static long MAX_TIME = 300000; // 5 mins. AlarmManager.INTERVAL_FIFTEEN_MINUTES;
  
  // time interval to consider a location update as fresh, for sensitive things like indoor positioning
  public static final long MAX_TIME_FOR_FRESH_LOCATION = 3600000000000000l; // 5 MINS
  ...
  public static String NEW_CHECKIN_ACTION = "com.singtel.goshopping.map.places.NEW_CHECKIN_ACTION";
  public static String RETRY_QUEUED_CHECKINS_ACTION = "com.singtel.goshopping.map.places.retry_queued_checkins";
  public static String ACTIVE_LOCATION_UPDATE_PROVIDER_DISABLED = "com.singtel.goshopping.map.places.active_location_update_provider_disabled";
