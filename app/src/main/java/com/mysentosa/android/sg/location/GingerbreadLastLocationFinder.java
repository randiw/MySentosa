...
public class GingerbreadLastLocationFinder implements ILastLocationFinder {
  ...
  protected static String SINGLE_LOCATION_UPDATE_ACTION = "com.singtel.goshopping.map.places.SINGLE_LOCATION_UPDATE_ACTION";
  ...
  public Location getLastBestLocation(int minDistance, long minTime) {
	minTime = System.currentTimeMillis() - minTime;  
  ...
  public void cancel() {
    locationManager.removeUpdates(singleUpatePI);
    // If receiver is pending for location, lets remove it as well at time of cancellation
    try {
    	context.unregisterReceiver(singleUpdateReceiver);
    } catch(Exception e){
    	// Receiver was not registered, nothing to worry
    }
  }
}
