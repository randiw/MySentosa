...
import com.mysentosa.android.sg.custom_views.CustomViewPager.OnPageChangeListener;
...
public class CirclePageIndicator extends View implements OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.CirclePageIndicator);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCentered) {
            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - (((count-1) * fourRadius+fourRadius/2) / 2.0f);
        }
    ...
    */
    ...
    public void setCurrentItem(int item, boolean isSoomthScroll) {
        if (mViewPager == null) {
            throw new IllegalStateException("ViewPager has not been bound.");
        }
        mViewPager.setCurrentItem(item,isSoomthScroll);
        mCurrentPage = item;
        invalidate();
    }
