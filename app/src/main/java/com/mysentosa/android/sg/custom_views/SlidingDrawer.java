...
public class SlidingDrawer extends ViewGroup {
    ...
    private int mBottom, mTop, mRight, mLeft;
    ...
    public SlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int orientation = ORIENTATION_VERTICAL;//a.getInt(R.styleable.SlidingDrawer_orientation, ORIENTATION_VERTICAL);
        mVertical = orientation == ORIENTATION_VERTICAL;
        mBottomOffset = (int)0;// a.getDimension(R.styleable.SlidingDrawer_bottomOffset, 0.0f);
        mViewHeight = (int) a.getDimension(R.styleable.SlidingDrawer_topOffset, 0.0f);
    ...
    protected void onFinishInflate() {
        ...
        mHandle.findViewById(R.id.iv_menu_main).setOnClickListener(new DrawerToggler());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTopOffset = heightSpecSize-mViewHeight;
        ...
        if (mVertical) {
            ...
            //LogHelper.d(" testing"," testing onMeasure height "+height);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mContentHeight = content.getHeight();
    ...
    private void moveHandle(int position) {
        ...
        if(mOnScrollListener != null) {
        	...
        	if(position == COLLAPSED_FULL_CLOSED) scrollDistance = mContentHeight;
        	else if(position == EXPANDED_FULL_OPEN) scrollDistance = 0;
        	else {
            	int scrollPosition = position-mTopOffset;
        		if(scrollPosition < 0) scrollDistance = 0;
        		else if(scrollPosition > mContentHeight) scrollDistance = mContentHeight;
        		else scrollDistance = scrollPosition;
        		
        	}
        	mOnScrollListener.onScroll(mContentHeight, scrollDistance);
        }
    ...
    private void doAnimation() {
        if (mAnimating) {
            //LogHelper.d(" testing"," testing animation position "+mAnimationPosition);
        	incrementAnimation();
...
//	private Rect mRect;
//	private boolean isContainingInsideHandle(final int x, final int y) {
//		if (mRect == null) {
//			mRect = new Rect();
//			mHandle.findViewById(R.id.iv_menu_main).getHitRect(mRect);
//		}
