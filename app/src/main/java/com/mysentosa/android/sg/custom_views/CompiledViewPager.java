...
import com.mysentosa.android.sg.adapter.CustomPagerAdapter;
 ...
 */
public class CompiledViewPager extends ViewGroup {
    ...
    private CustomPagerAdapter.DataSetObserver mObserver;
    ...
    public interface OnPageChangeListener {
         ...
         * @see CompiledViewPager#SCROLL_STATE_IDLE
         * @see CompiledViewPager#SCROLL_STATE_DRAGGING
         * @see CompiledViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public CompiledViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public CompiledViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
    ...
    public void setCurrentItem(int item, boolean isSmoothScroll) {
        mPopulatePending = false;
        setCurrentItemInternal(item, isSmoothScroll, false);
    }
    ...
    //To implement the click listener
    public static interface OnFrameClickListener {

		/**
		 * Notifies listeners about receiving a single click
		 * 
		 * @param toggleThumbnails toggles thumbnail scrollview
		 */
		void onSingleClickReceived(int pageNo);

	}

	private OnFrameClickListener mOnFrameClickListener = null;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        	...
        	if(action == MotionEvent.ACTION_UP) {
        		if(isClick) {
        			...
        			if(mOnFrameClickListener!=null)
        				mOnFrameClickListener.onSingleClickReceived(mCurItem);
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (xDiff > mTouchSlop && xDiff > yDiff) {
                	//set isClick to false if it is detected as a move
                	isClick = false;
            ...
            case MotionEvent.ACTION_DOWN: {
            	//We set the isClick to true. If by the end of the touch event series, it 
            	//is still true, a click event is registered
            	isClick = true;
                /*
    ...
    private class DataSetObserver implements CustomPagerAdapter.DataSetObserver {
        @Override
